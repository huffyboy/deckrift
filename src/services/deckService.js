 ...
 * Handles all deck operations for the game including:
 * - Player main deck (runData.playerDeck)
 * - Player battle deck (fightStatus.playerDeck)
 * - Enemy deck (fightStatus.enemyDeck)
 * - Standard deck generation
 * - Card operations (add, remove, draw, shuffle)
 */
